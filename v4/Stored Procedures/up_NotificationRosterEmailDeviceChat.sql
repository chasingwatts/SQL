...
DROP PROCEDURE IF EXISTS up_NotificationRosterEmailDeviceChat;
GO

CREATE PROCEDURE up_NotificationRosterEmailDeviceChat
    @ActivityID INT,
...
/******************************************************************************
*  Script Name:  	up_NotificationRosterEmailDeviceChat
...
-- EXEC up_NotificationRosterEmailDeviceChat 10, 2, 1
...
BEGIN
    ...
    WHERE R.ActivityID = @ActivityID
      ...
      AND U.IsDeleted = 0
      AND (
          (@Type = 1 AND N.ActivityDiscussionApp = 1)
