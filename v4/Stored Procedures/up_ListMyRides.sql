...
DROP PROCEDURE IF EXISTS up_ListMyRides
GO

CREATE PROCEDURE up_ListMyRides
	@UserID int
AS
--/******************************************************************************
--*  DBA Script: up_ListMyRides
--*  Created By: Jason Codianne 
--*  Created:    02/26/2024
--*  Schema:     dbo
--*  Purpose:    List activities where user created or is in roster.
--******************************************************************************/
-- ============================================================================
-- Testing Parms
-- EXEC up_ListMyRides 1
...
LEFT OUTER JOIN ActivityRoster AR ON G.ActivityRosterGroupID = AR.ActivityRosterGroupID
	AND AR.ResponseTypeID <> 3 --no
WHERE A.IsDeleted = 0
			...
			AND (A.UserID = @UserID OR AR.CreatedBy = @UserID)
