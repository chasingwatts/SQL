...
DROP PROCEDURE IF EXISTS up_ListUserNextRide
GO

CREATE PROCEDURE up_ListUserNextRide
	@UserID int
AS
--/******************************************************************************
--*  DBA Script: up_ListUserNextRide
...
ORDER BY ActivityGeoPt.STDistance(@CurrentLocation) ASC
