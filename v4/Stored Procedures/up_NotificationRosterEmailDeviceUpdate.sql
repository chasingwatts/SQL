...
DROP PROCEDURE IF EXISTS up_NotificationRosterEmailDeviceUpdate;
GO

CREATE PROCEDURE up_NotificationRosterEmailDeviceUpdate
    @ActivityID INT,
...
/******************************************************************************
*  Script Name:  	up_NotificationRosterEmailDeviceUpdate
...
-- EXEC up_NotificationRosterEmailDeviceUpdate 10, 2, 1
...
BEGIN
    ...
    WHERE R.ActivityID = @ActivityID
      ...
      AND U.IsDeleted = 0
      AND (
          (@Type = 1 AND N.ActivityUpdateApp = 1)
