...
DROP PROCEDURE IF EXISTS up_ListFriendsByRadiusCount
GO

CREATE PROCEDURE up_ListFriendsByRadiusCount
	@UserID int,
	@Distance float
AS
/******************************************************************************
*  DBA Script: up_ListFriendsByRadiusCount
...
-- ============================================================================
-- Testing Parms
-- EXEC up_ListFriendsByRadiusCount 1, 100
-- ============================================================================
...
SELECT 
	ISNULL(COUNT(X.UserID), 0) AS UserCount
