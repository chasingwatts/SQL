...
DROP PROCEDURE dbo.up_ListLatestActivitiesByLocation
GO

CREATE PROCEDURE dbo.up_ListLatestActivitiesByLocation
	@UserID int,
	@Distance float,
	@StartLat float,
	@StartLng float
AS
/******************************************************************************
*  DBA Script: up_ListLatestActivitiesByLocation
...
-- ============================================================================
-- Testing Parms
-- EXEC up_ListLatestActivitiesByLocation 1, 200, 29.8174768, -95.6821576 --HTX
-- EXEC up_ListLatestActivitiesByLocation 1, 160, 32.8010232, -97.4297448 --FTW
