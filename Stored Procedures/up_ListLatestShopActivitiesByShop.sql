...
DROP PROCEDURE IF EXISTS up_ListLatestShopActivitiesByShop
GO

CREATE PROCEDURE up_ListLatestShopActivitiesByShop
	@ShopID int,
	@UserID int
AS
/******************************************************************************
*  DBA Script: [up_ListLatestShopActivitiesByShop]
...
-- ============================================================================
-- Testing Parms
-- EXEC up_ListLatestShopActivitiesByShop 1, 1
