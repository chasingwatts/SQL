...
DROP PROCEDURE dbo.up_ListDashboardRides
GO

CREATE PROCEDURE dbo.up_ListDashboardRides
	@UserID int,
	@Distance float,
	@ActivityTypeID int,
...
AS
--/******************************************************************************
--*  DBA Script: up_ListDashboardRides
...
-- ============================================================================
-- Testing Parms
-- EXEC up_ListDashboardRides 1, 200, null, null
